...
st.title("國中生活科技三年級－Python 單選測驗")
st.caption("請輸入基本資料後作答，送出後會記錄成績。")

# ===== 題庫 =====
questions = [
    {
        "q": "1. Python 用來在畫面上顯示文字的指令是？",
    ...
    {
        "q": "3. 用來讓使用者輸入資料的指令是？",
        "options": ["print()", "type()", "input()", "write()"],
        "ans": "input()"
    },
    {
        "q": "4. 下列哪一項是整數資料型態？",
    ...
    {
        "q": "5. 判斷條件是否成立時，會使用哪一個指令？",
        "options": ["for", "while", "if", "print"],
        "ans": "if"
    },
    {
        "q": "6. 若條件不成立時要執行的指令為？",
        "options": ["elif", "else", "then", "do"],
        "ans": "else"
    },
    {
        "q": "7. 用來重複執行程式碼的結構是？",
        "options": ["if", "print", "loop", "for"],
        "ans": "for"
    },
    {
        "q": "8. range(5) 會產生哪些數字？",
    ...
    {
        "q": "13. append() 指令的用途是？",
        "options": ["刪除資料", "新增資料", "排序資料", "取代資料"],
        "ans": "新增資料"
    },
    {
        "q": "14. 若要取得清單第一個元素，索引值為？",
        "options": ["1", "0", "-1", "2"],
        "ans": "0"
    },
    {
        "q": "15. while 迴圈的特色是？",
        "options": ["固定次數", "依條件重複", "只執行一次", "不能停止"],
        "ans": "依條件重複"
    },
    {
        "q": "16. # 在 Python 中代表？",
    ...
    {
        "q": "19. 程式發生錯誤時，畫面顯示的訊息稱為？",
        "options": ["警告", "錯誤訊息", "輸出", "結果"],
        "ans": "錯誤訊息"
    },
    {
        "q": "20. Python 程式是一行一行依什麼順序執行？",
        "options": ["隨機", "由下往上", "由左往右", "由上往下"],
        "ans": "由上往下"
    }
]
...
if st.button("送出測驗"):
    if not seat_no or not name or not class_name:
        st.error("請先填寫完整學生資料。")
    else:
        score = 0
